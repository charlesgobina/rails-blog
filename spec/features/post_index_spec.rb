...
RSpec.describe 'post_index_route', type: :feature do
  describe 'Post' do
    before(:each) do
      User.create(name: 'Affaxed', photo: 'link', bio: 'bio', posts_counter: 0,
                  email: 'rb@gmail.com', password: '123456', password_confirmation: '123456')
      visit new_user_session_path
      fill_in 'Email', with: 'rb@gmail.com'
      fill_in 'Password', with: '123456'
      click_button 'Log in'
      Post.create(title: 'First Post', text: 'This is the first post', comments_counter: 0, like_counter: 0,
                  author: User.first)
      Post.create(title: 'Second Post', text: 'This is the second post', comments_counter: 0, like_counter: 0,
                  author: User.first)
      Post.create(title: 'Third Post', text: 'This is the third post', comments_counter: 0, like_counter: 0,
                  author: User.first)
